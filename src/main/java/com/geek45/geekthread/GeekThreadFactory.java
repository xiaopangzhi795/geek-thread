...
import com.geek45.geekthread.strategy.GeneratorNameFactory;
...
public class GeekThreadFactory implements ThreadFactory {
    ...
    public static <R extends DefaultThreadCallback> GeekThreadFactory create(ThreadConfiguration configuration, GeekUncaughtExceptionHandler<R> handler, ThreadFactory factory) {
    ...
    public static <R extends DefaultThreadCallback> GeekThreadFactory create(ThreadConfiguration configuration, GeekUncaughtExceptionHandler<R> handler) {
    ...
    public static GeekThreadFactory create(ThreadConfiguration configuration) {
        GeekThreadFactory factory = baseInit(configuration);
    ...
    private static GeekThreadFactory baseInit(ThreadConfiguration configuration) {
        ...
        factory.generatorStrategy = GeneratorNameFactory.create(configuration.getGeneratorNameType(), configuration.getKey());
        return factory;
    }
